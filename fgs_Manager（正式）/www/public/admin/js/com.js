! function(a) {
	...
	$(document).ready(function() {
		mainObj.init(), mainObj.resizeFn(),
			...
			mainObj.judgeBro() && ($("#style").attr("href", "css/style.css"),
	...
	var mainObj = {
			...
			if(this.is_pc()) {
				...
				a.mousemove(function(a) {
					...
					b.css({
						...
						c.css({
							"margin-left": h.margin_left - .3 * p + "px",
							"margin-top": h.margin_top - .3 * q + "px"
						}),
						d.css({
							"margin-left": i.margin_left + 1.2 * p + "px",
							"margin-top": i.margin_top + 1.2 * q + "px"
						}),
						e.css({
							"margin-left": j.margin_left - 1.2 * p + "px",
							"margin-top": j.margin_top - 1.2 * q + "px"
						}),
						f.css({
							"margin-left": k.margin_left - .6 * p + "px",
							"margin-top": k.margin_top - .6 * q + "px"
						})
				})
			} else
				this.$menu.hide(),
		...
		changeCls: function(a) {
			this.$par.children().each(function(b) {
				var c = mainObj.subCls.clsArr[0],
					d = mainObj.subCls.clsArr[1],
					e = mainObj.subCls.clsArr[2];
		...
		is_pc: function() {
			for(var a = new Array("Android", "iPhone", "Windows Phone", "iPod", "iPad", "BlackBerry", "MeeGo", "SymbianOS"),
					b = navigator.userAgent, c = a.length, d = 0; c > d; d++)
