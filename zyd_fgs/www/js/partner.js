...
$('.fgs-join').click(function() {
	window.location.href = "join_city.html?onlyID=" + onlyID;
});

$('.fgs-create').click(function() {
	window.location.href = "create_city.html?onlyID=" + onlyID;
})
...
$('.fgs-test').click(function() {
	window.location.href = "directions.html?onlyID=" + onlyID +"&fgsType=shi";
})
...
$(document).ready(function() {
	...
	$.ajax({
		type: "POST",
		url: "/ajax.post?func=CZ_fgs_my_shijifgslist",
		data: 'data=' + data,
		success: function(p) {
