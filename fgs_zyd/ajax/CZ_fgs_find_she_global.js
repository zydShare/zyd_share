...
module.exports.run = function (body, pg, mo) {
	...
	sql = "select a.id,a.名称,a.编号,a.类别,b.单股金额 from 分_分公司表 a,分_分公司设置表 b where 编号 ='" + f.分公司编号 + "' and a.类别 = b.名称 and b.状态 ='显示' and b.名称='社区代理分公司'";
