...
module.exports.run = function (body, pg, mo) {
	...
	sql = "select 市 from 分_分公司表 where 编号='"+f.分公司编号+"'";
	...
	var sql="select 编号,名称 from 分_分公司表 where 市='"+f.附属市+"' and 类别='市代理分公司' order by 录入时间 desc  limit " + 每页条数 + " offset " + 开始条数;
