...
//  }
	...
	if(f.超级商家 =='是')
	{
		sql = "select id, 名称, Round(@股数,0) as 股数, Round(@单股金额,0) as 单股金额,类别  from 分_分公司设置表 where 状态 ='显示' and 名称='市代理分公司'";
	...
	{
		sql = "select id, 名称, Round(@股数,0) as 股数, Round(@单股金额,0) as 单股金额,类别  from 分_分公司设置表 where 状态 ='显示中' and 名称='市代理分公司'";
