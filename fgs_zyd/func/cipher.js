...
cipher.Newtimes = function(Newtimes,Number)
{
		var times='';
		if(Newtimes==null)
		{
		...
		{
			var now = new Date(Newtimes);
			var lastMonth = new Date((now/1000+(Number*24*60*60))*1000);
			var ty='YYYY-MM-DD HH:mm:ss';
			times = moment(lastMonth).format(ty);
			return times;
		}
}
